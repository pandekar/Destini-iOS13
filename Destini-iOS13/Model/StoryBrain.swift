...
struct StoryBrain {
    ...
    func getTitle() -> String {
        return stories[checkPoint].title
    }
    
    // get choice 1 title
    func getChoice1Title() -> String {
        return stories[checkPoint].choice1
    }
    
    // get choice 1 destination
    func getChoice1Destination() -> Int {
        return stories[checkPoint].choice1Destination
    }
    
    // get choice 2 title
    func getChoice2Title() -> String {
        return stories[checkPoint].choice2
    }
    
    // get choice 1 destination
    func getChoice2Destination() -> Int {
        return stories[checkPoint].choice2Destination
    }
    
    // next route
    mutating func nextRoute(route: Int) {
